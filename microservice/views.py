...
class MicroserviceSearchView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        try:
            ...
            try:
                json_formatted = {
                    ...
                    "results": [{
                        ...
                        "authors": [{"name": author['full_name']} for author in item['authors'] if author['full_name'] is not None]
                    } for item in req.json() if item['title'] is not None]
                }
            ...
            result = {"error": "Unfortunately an error occurred when attempting to connect to the upstream host."}
